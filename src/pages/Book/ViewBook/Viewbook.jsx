...
const ViewBook  = () => {
  ...
  // Fetch book list - simulate with mock data for now
  useEffect(() => {
    // Replace with API call to fetch books if needed
    setBooks([
      { id: '684567c1298c26f3da04cb9a', title: 'React Basics', enabled: true },
      { id: 'book2', title: 'Learning Tailwind', enabled: false },
    ]);
  }, []);
  ...
  const handleDelete = async (bookId) => {
    ...
    try {
      await axios.delete(`https://rungeenbooks.onrender.com/api/books/books/delete-by-category/${bookId}`);
      // Remove from UI
